...
function t() {
    return new y.default(function(e, r) {
        c.setVisitKey(s.wxaProxy(p.PTAG_URL), function(n) {
            n ? e(n) : r("");
        });
    });
}
...
}(), s = e(require("../../common/url_utils")), c = e(require("./report")), a = e(require("../../common/user_info")), f = require("../../common/request/request.js"), l = e(require("../../common/cookie-v2/cookie.js")), p = e(require("../APIs.js")), y = function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
}(require("../../libs/promise.min.js"));

exports.Mercury = function() {
    function e() {
        r(this, e);
    }
    return i(e, null, [ {
