    ...
    show: function() {
        ...
        if ("string" == typeof t.title && "string" == typeof t.content) {
            var o = {
                ...
                freightDiscount: t.freightDiscount,
                taxInfo: t.taxInfo,
                sameStockGoods: t.sameStockGoods,
                goods: t.goods,
            ...
            if (t.page) this.page = t.page; else {
                var c = getCurrentPages();
                this.page = c[c.length - 1];
            }
            t.content && t.content.indexOf("<br>") > 0 && (o.content = t.content.split("<br>"), 
...
exports.hide = e.hide, exports.show = e.show;