...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.setDebugChannel = exports.Dispatcher = void 0;
...
u.init(), exports.Dispatcher = u, exports.setDebugChannel = function(e) {
    "http" == e ? i.socket.handler = a.HTTP : "httpDirect" == e ? (a.HTTP.setDebugMode(), 
    i.socket.handler = a.HTTP) : "ws" == e && (i.http.handler = c.Socket), console.warn("[Dispatcher.setDebugChannel] 启用网络请求调试模式！", e);
};