...
function a(t, e, n) {
    for (var r = (e = (e = e.replace(/\[(\w+)\]/g, ".$1")).replace(/^\./, "")).split("."), a = 0, o = r.length; a < o; ++a) {
        var i = r[a];
        if (!(i in t)) return t[i] = n, n;
        t = t[i];
    }
    return t;
}
...
var o = function() {
...
}(), i = require("./base.js"), u = function(u) {
    function s(t, r) {
        e(this, s);
    ...
    return r(s, i.Base), o(s, [ {
        ...
        value: function() {
            var t = this, e = this, n = [ "onLoad", "onReady", "onShow", "onHide", "onUnload" ], r = !0, a = !1, o = void 0;
            try {
        ...
        value: function(t) {
            ...
            (e = this.page).setData.apply(e, [ r ].concat(i));
        }
    }, {
        key: "onLoad",
        value: function() {}
