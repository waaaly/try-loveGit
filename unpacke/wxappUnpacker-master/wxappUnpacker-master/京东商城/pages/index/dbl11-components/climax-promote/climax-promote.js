    ...
    methods: {
        ...
        renderMall: function(t) {
            ...
            a.default.resolve(t).then(function(t) {
                if (!l.checkTime(o.CLIMAX_BEGIN, o.CLIMAX_END)) return e.triggerEvent("componentLoad", e.is), 
                void e.setData({
                    hideModule: !0
                });
                var r = t && t.dbl11 && t.dbl11.ppms && t.dbl11.ppms.plBanner || [], n = e.getConfig(r);
                if (!n) return a.default.reject();
                a.default.all([ e.getCpcData(10877, 28789), e.getCenterData(6450, 5), e.getRightCpcData(n.rightBannerVk, 10877, 28790, 28791) ]).then(function(t) {
        ...
        renderWallet: function() {
            var t = this;
            l.checkTime(o.CLIMAX_BEGIN, o.CLIMAX_END) ? a.default.all([ this.getCpcData(10877, 28789), this.getCenterData(6450, 5), this.getWalletRightCpcData(10877, 28790, 28791) ]).then(function(e) {
