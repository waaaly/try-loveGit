...
function e(o) {
    u = [], console.log("查询日志上报白名单"), wx.request({
        ...
        success: function(e) {
            console.log(e);
            var n = e.data;
            -2 == n.retcode && console.log("未登录"), n && "object" == (void 0 === n ? "undefined" : r(n)) && (u = n), 
            o();
        },
        fail: function(o) {
...
function n(o) {
    var e = i.default.getCookie("jdpin");
    for (var n in u) {
...
}(require("./cookie-v2/cookie.js")), c = [], u = null, l = 0;

exports.log = function() {
    var t = [];
    clearTimeout(l);
    for (var i = arguments.length, s = Array(i), f = 0; f < i; f++) s[f] = arguments[f];
    for (var a in s) "object" == r(s[a]) ? t.push(JSON.stringify(s[a])) : t.push(s[a]);
